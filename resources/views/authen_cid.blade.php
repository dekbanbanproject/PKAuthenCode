            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <input type="text" class="form-control" id="check_cid_authen" name="check_cid_authen" >  
                            </div>
                        </div> 
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-2 text-end">
                                <div class="mb-3">
                                    <label for="pid" class="form-label">cid :</label>                           
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3"> 
                                    <input type="text" class="form-control" id="check_cid" name="check_cid" value="{{$datacid}}" readonly> 
                                </div>
                            </div> 
